...
namespace FCP
{
    ...
    public class OutlineEffect : MonoBehaviour
    {
        ...
        public Shader tempOutlineShader;
        Shader outlineBufferShader;
        public Shader tempOutlineBufferShader;
        ...
        private void CreateMaterialsIfNeeded()
        {
            if (outlineShader == null)
                outlineShader = tempOutlineShader;
            ...
            if (outlineBufferShader == null)
                outlineBufferShader = tempOutlineBufferShader;
                //outlineBufferShader = Resources.Load<Shader>("OutlineBufferShader");
                //outlineBufferShader = Shader.Find("Hidden/OutlineBufferShader");
